...
fr = st.number_input("Resonant Frequency in GHz (fr)",min_value=0,max_value=5,)
fl = st.number_input("Lower-cutoff Frequency in GHz (fl)")
fh = st.number_input("Higher-cutoff Frequency in GHz (fh)")
